...
public class FabricItemGroupAdditions {
    ...
    public static void modifyCreativeTabs() {
        ItemGroupEvents.modifyEntriesEvent(CreativeModeTabs.COLORED_BLOCKS).register(entries -> {
            ...
            entries.addAfter(DDBlocks.CORAL_WOOL.get(), DDBlocks.UMBER_WOOL.get());
            ...
            entries.addAfter(Blocks.PURPLE_WOOL, DDBlocks.LAVENDER_WOOL.get());
            entries.addAfter(Blocks.MAGENTA_WOOL, DDBlocks.SANGRIA_WOOL.get());
            entries.addAfter(Blocks.PINK_WOOL, DDBlocks.ROSE_WOOL.get());

            //CARPET
            entries.addAfter(Blocks.RED_CARPET, DDBlocks.CORAL_CARPET.get());
            entries.addAfter(DDBlocks.CORAL_CARPET.get(), DDBlocks.UMBER_CARPET.get());
            ...
            entries.addAfter(Blocks.PURPLE_CARPET, DDBlocks.LAVENDER_CARPET.get());
            entries.addAfter(Blocks.MAGENTA_CARPET, DDBlocks.SANGRIA_CARPET.get());
            ...
            entries.addAfter(DDBlocks.CORAL_TERRACOTTA.get(), DDBlocks.UMBER_TERRACOTTA.get());
            ...
            entries.addAfter(Blocks.PURPLE_TERRACOTTA, DDBlocks.LAVENDER_TERRACOTTA.get());
            entries.addAfter(Blocks.MAGENTA_TERRACOTTA, DDBlocks.SANGRIA_TERRACOTTA.get());
            ...
            entries.addAfter(DDBlocks.CORAL_CONCRETE.get(), DDBlocks.UMBER_CONCRETE.get());
            ...
            entries.addAfter(Blocks.PURPLE_CONCRETE, DDBlocks.LAVENDER_CONCRETE.get());
            entries.addAfter(Blocks.MAGENTA_CONCRETE, DDBlocks.SANGRIA_CONCRETE.get());
            ...
            entries.addAfter(DDBlocks.CORAL_CONCRETE_POWDER.get(), DDBlocks.UMBER_CONCRETE_POWDER.get());
            ...
            entries.addAfter(Blocks.PURPLE_CONCRETE_POWDER, DDBlocks.LAVENDER_CONCRETE_POWDER.get());
            entries.addAfter(Blocks.MAGENTA_CONCRETE_POWDER, DDBlocks.SANGRIA_CONCRETE_POWDER.get());
            ...
            entries.addAfter(DDBlocks.CORAL_GLAZED_TERRACOTTA.get(), DDBlocks.UMBER_GLAZED_TERRACOTTA.get());
            ...
            entries.addAfter(Blocks.PURPLE_GLAZED_TERRACOTTA, DDBlocks.LAVENDER_GLAZED_TERRACOTTA.get());
            entries.addAfter(Blocks.MAGENTA_GLAZED_TERRACOTTA, DDBlocks.SANGRIA_GLAZED_TERRACOTTA.get());
            ...
            entries.addAfter(DDBlocks.CORAL_STAINED_GLASS.get(), DDBlocks.UMBER_STAINED_GLASS.get());
            ...
            entries.addAfter(Blocks.PURPLE_STAINED_GLASS, DDBlocks.LAVENDER_STAINED_GLASS.get());
            entries.addAfter(Blocks.MAGENTA_STAINED_GLASS, DDBlocks.SANGRIA_STAINED_GLASS.get());
            ...
            entries.addAfter(DDBlocks.CORAL_STAINED_GLASS_PANE.get(), DDBlocks.UMBER_STAINED_GLASS_PANE.get());
            ...
            entries.addAfter(Blocks.PURPLE_STAINED_GLASS_PANE, DDBlocks.LAVENDER_STAINED_GLASS_PANE.get());
            entries.addAfter(Blocks.MAGENTA_STAINED_GLASS_PANE, DDBlocks.SANGRIA_STAINED_GLASS_PANE.get());
            ...
            entries.addAfter(DDBlocks.CORAL_SHULKER_BOX.get(), DDBlocks.UMBER_SHULKER_BOX.get());
            ...
            entries.addAfter(Blocks.PURPLE_SHULKER_BOX, DDBlocks.LAVENDER_SHULKER_BOX.get());
            entries.addAfter(Blocks.MAGENTA_SHULKER_BOX, DDBlocks.SANGRIA_SHULKER_BOX.get());
            ...
            entries.addAfter(DDBlocks.CORAL_BED.get(), DDBlocks.UMBER_BED.get());
            ...
            entries.addAfter(Blocks.PURPLE_BED, DDBlocks.LAVENDER_BED.get());
            entries.addAfter(Blocks.MAGENTA_BED, DDBlocks.SANGRIA_BED.get());
            entries.addAfter(Blocks.PINK_BED, DDBlocks.ROSE_BED.get());

            //CANDLE
            entries.addAfter(Blocks.RED_CANDLE, DDBlocks.CORAL_CANDLE.get());
            entries.addAfter(DDBlocks.CORAL_CANDLE.get(), DDBlocks.UMBER_CANDLE.get());
            ...
            entries.addAfter(Blocks.PURPLE_CANDLE, DDBlocks.LAVENDER_CANDLE.get());
            entries.addAfter(Blocks.MAGENTA_CANDLE, DDBlocks.SANGRIA_CANDLE.get());
            entries.addAfter(Blocks.PINK_CANDLE, DDBlocks.ROSE_CANDLE.get());

            //BANNER
            entries.addAfter(Blocks.RED_BANNER, DDBlocks.CORAL_BANNER.get());
            entries.addAfter(DDBlocks.CORAL_BANNER.get(), DDBlocks.UMBER_BANNER.get());
            ...
            entries.addAfter(Blocks.PURPLE_BANNER, DDBlocks.LAVENDER_BANNER.get());
            entries.addAfter(Blocks.MAGENTA_BANNER, DDBlocks.SANGRIA_BANNER.get());
        ...
        ItemGroupEvents.modifyEntriesEvent(CreativeModeTabs.INGREDIENTS).register(entries -> {
            ...
            entries.addAfter(DDItems.CORAL_DYE.get(), DDItems.UMBER_DYE.get());
            ...
            entries.addAfter(Items.PURPLE_DYE, DDItems.LAVENDER_DYE.get());
            entries.addAfter(Items.MAGENTA_DYE, DDItems.SANGRIA_DYE.get());
