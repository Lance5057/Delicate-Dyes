...
public class DDRecipeGen extends FabricRecipeProvider {
    ...
    public static void oneToTwoConversionRecipe(RecipeOutput finishedRecipeConsumer, ItemLike result, ItemLike ingredient, @Nullable String group) {
        oneToTwoConversionRecipe(finishedRecipeConsumer, result, ingredient, group, 2);
    }

    public static void oneToTwoConversionRecipe(RecipeOutput finishedRecipeConsumer, ItemLike result, ItemLike ingredient, @Nullable String group, int resultCount) {
