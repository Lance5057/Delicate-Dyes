...
public class DDLangGen extends FabricLanguageProvider {
    ...
    public void generateTranslations(HolderLookup.Provider provider, TranslationBuilder build) {
        //BLOCKS
        build.add(DDBlocks.ROSE.value(), "Rose");
        build.add(DDBlocks.RED_ROSE.value(), "Red Rose");
        build.add(DDBlocks.BLUE_ROSE.value(), "Blue Rose");
        build.add(DDBlocks.WHITE_ROSE.value(), "White Rose");

        build.add(DDBlocks.CORAL_WOOL.value(), "Coral Wool");
        build.add(DDBlocks.CORAL_CARPET.value(), "Coral Carpet");
        build.add(DDBlocks.CORAL_STAINED_GLASS.value(), "Coral Stained Glass");
        build.add(DDBlocks.CORAL_STAINED_GLASS_PANE.value(), "Coral Stained Glass Pane");
        build.add(DDBlocks.CORAL_TERRACOTTA.value(), "Coral Terracotta");
        build.add(DDBlocks.CORAL_GLAZED_TERRACOTTA.value(), "Coral Glazed Terracotta");
        build.add(DDBlocks.CORAL_CONCRETE.value(), "Coral Concrete");
        build.add(DDBlocks.CORAL_CONCRETE_POWDER.value(), "Coral Concrete Powder");
        build.add(DDBlocks.CORAL_CANDLE.value(), "Coral Candle");
        build.add(DDBlocks.CORAL_CANDLE_CAKE.value(), "Coral Candle Cake");
        //build.add(DDBlocks.CORAL_SHULKER_BOX.value(), "Coral Shulker Box");

        build.add(DDBlocks.CANARY_WOOL.value(), "Canary Wool");
        build.add(DDBlocks.CANARY_CARPET.value(), "Canary Carpet");
        build.add(DDBlocks.CANARY_STAINED_GLASS.value(), "Canary Stained Glass");
        build.add(DDBlocks.CANARY_STAINED_GLASS_PANE.value(), "Canary Stained Glass Pane");
        build.add(DDBlocks.CANARY_TERRACOTTA.value(), "Canary Terracotta");
        build.add(DDBlocks.CANARY_GLAZED_TERRACOTTA.value(), "Canary Glazed Terracotta");
        build.add(DDBlocks.CANARY_CONCRETE.value(), "Canary Concrete");
        build.add(DDBlocks.CANARY_CONCRETE_POWDER.value(), "Canary Concrete Powder");
        build.add(DDBlocks.CANARY_CANDLE.value(), "Canary Candle");
        build.add(DDBlocks.CANARY_CANDLE_CAKE.value(), "Canary Candle Cake");
        //build.add(DDBlocks.CANARY_SHULKER_BOX.value(), "Canary Shulker Box");

        build.add(DDBlocks.WASABI_WOOL.value(), "Wasabi Wool");
        build.add(DDBlocks.WASABI_CARPET.value(), "Wasabi Carpet");
        build.add(DDBlocks.WASABI_STAINED_GLASS.value(), "Wasabi Stained Glass");
        build.add(DDBlocks.WASABI_STAINED_GLASS_PANE.value(), "Wasabi Stained Glass Pane");
        build.add(DDBlocks.WASABI_TERRACOTTA.value(), "Wasabi Terracotta");
        build.add(DDBlocks.WASABI_GLAZED_TERRACOTTA.value(), "Wasabi Glazed Terracotta");
        build.add(DDBlocks.WASABI_CONCRETE.value(), "Wasabi Concrete");
        build.add(DDBlocks.WASABI_CONCRETE_POWDER.value(), "Wasabi Concrete Powder");
        build.add(DDBlocks.WASABI_CANDLE.value(), "Wasabi Candle");
        build.add(DDBlocks.WASABI_CANDLE_CAKE.value(), "Wasabi Candle Cake");
        //build.add(DDBlocks.WASABI_SHULKER_BOX.value(), "Wasabi Shulker Box");

        build.add(DDBlocks.SACRAMENTO_WOOL.value(), "Sacramento Wool");
        build.add(DDBlocks.SACRAMENTO_CARPET.value(), "Sacramento Carpet");
        build.add(DDBlocks.SACRAMENTO_STAINED_GLASS.value(), "Sacramento Stained Glass");
        build.add(DDBlocks.SACRAMENTO_STAINED_GLASS_PANE.value(), "Sacramento Stained Glass Pane");
        build.add(DDBlocks.SACRAMENTO_TERRACOTTA.value(), "Sacramento Terracotta");
        build.add(DDBlocks.SACRAMENTO_GLAZED_TERRACOTTA.value(), "Sacramento Glazed Terracotta");
        build.add(DDBlocks.SACRAMENTO_CONCRETE.value(), "Sacramento Concrete");
        build.add(DDBlocks.SACRAMENTO_CONCRETE_POWDER.value(), "Sacramento Concrete Powder");
        build.add(DDBlocks.SACRAMENTO_CANDLE.value(), "Sacramento Candle");
        build.add(DDBlocks.SACRAMENTO_CANDLE_CAKE.value(), "Sacramento Candle Cake");
        //build.add(DDBlocks.SACRAMENTO_SHULKER_BOX.value(), "Sacramento Shulker Box");

        build.add(DDBlocks.SKY_WOOL.value(), "Sky Wool");
        build.add(DDBlocks.SKY_CARPET.value(), "Sky Carpet");
        build.add(DDBlocks.SKY_STAINED_GLASS.value(), "Sky Stained Glass");
        build.add(DDBlocks.SKY_STAINED_GLASS_PANE.value(), "Sky Stained Glass Pane");
        build.add(DDBlocks.SKY_TERRACOTTA.value(), "Sky Terracotta");
        build.add(DDBlocks.SKY_GLAZED_TERRACOTTA.value(), "Sky Glazed Terracotta");
        build.add(DDBlocks.SKY_CONCRETE.value(), "Sky Concrete");
        build.add(DDBlocks.SKY_CONCRETE_POWDER.value(), "Sky Concrete Powder");
        build.add(DDBlocks.SKY_CANDLE.value(), "Sky Candle");
        build.add(DDBlocks.SKY_CANDLE_CAKE.value(), "Sky Candle Cake");
        //build.add(DDBlocks.SKY_SHULKER_BOX.value(), "Sky Shulker Box");

        build.add(DDBlocks.BLURPLE_WOOL.value(), "Blurple Wool");
        build.add(DDBlocks.BLURPLE_CARPET.value(), "Blurple Carpet");
        build.add(DDBlocks.BLURPLE_STAINED_GLASS.value(), "Blurple Stained Glass");
        build.add(DDBlocks.BLURPLE_STAINED_GLASS_PANE.value(), "Blurple Stained Glass Pane");
        build.add(DDBlocks.BLURPLE_TERRACOTTA.value(), "Blurple Terracotta");
        build.add(DDBlocks.BLURPLE_GLAZED_TERRACOTTA.value(), "Blurple Glazed Terracotta");
        build.add(DDBlocks.BLURPLE_CONCRETE.value(), "Blurple Concrete");
        build.add(DDBlocks.BLURPLE_CONCRETE_POWDER.value(), "Blurple Concrete Powder");
        build.add(DDBlocks.BLURPLE_CANDLE.value(), "Blurple Candle");
        build.add(DDBlocks.BLURPLE_CANDLE_CAKE.value(), "Blurple Candle Cake");
        //build.add(DDBlocks.BLURPLE_SHULKER_BOX.value(), "Blurple Shulker Box");

        build.add(DDBlocks.SANGRIA_WOOL.value(), "Sangria Wool");
        build.add(DDBlocks.SANGRIA_CARPET.value(), "Sangria Carpet");
        build.add(DDBlocks.SANGRIA_STAINED_GLASS.value(), "Sangria Stained Glass");
        build.add(DDBlocks.SANGRIA_STAINED_GLASS_PANE.value(), "Sangria Stained Glass Pane");
        build.add(DDBlocks.SANGRIA_TERRACOTTA.value(), "Sangria Terracotta");
        build.add(DDBlocks.SANGRIA_GLAZED_TERRACOTTA.value(), "Sangria Glazed Terracotta");
        build.add(DDBlocks.SANGRIA_CONCRETE.value(), "Sangria Concrete");
        build.add(DDBlocks.SANGRIA_CONCRETE_POWDER.value(), "Sangria Concrete Powder");
        build.add(DDBlocks.SANGRIA_CANDLE.value(), "Sangria Candle");
        build.add(DDBlocks.SANGRIA_CANDLE_CAKE.value(), "Sangria Candle Cake");
        //build.add(DDBlocks.SANGRIA_SHULKER_BOX.value(), "Sangria Shulker Box");

        build.add(DDBlocks.ROSE_WOOL.value(), "Rose Wool");
        build.add(DDBlocks.ROSE_CARPET.value(), "Rose Carpet");
        build.add(DDBlocks.ROSE_STAINED_GLASS.value(), "Rose Stained Glass");
        build.add(DDBlocks.ROSE_STAINED_GLASS_PANE.value(), "Rose Stained Glass Pane");
        build.add(DDBlocks.ROSE_TERRACOTTA.value(), "Rose Terracotta");
        build.add(DDBlocks.ROSE_GLAZED_TERRACOTTA.value(), "Rose Glazed Terracotta");
        build.add(DDBlocks.ROSE_CONCRETE.value(), "Rose Concrete");
        build.add(DDBlocks.ROSE_CONCRETE_POWDER.value(), "Rose Concrete Powder");
        build.add(DDBlocks.ROSE_CANDLE.value(), "Rose Candle");
        build.add(DDBlocks.ROSE_CANDLE_CAKE.value(), "Rose Candle Cake");
        //build.add(DDBlocks.ROSE_SHULKER_BOX.value(), "Rose Shulker Box");

        //ITEMS
        build.add(DDItems.CORAL_DYE.value(), "Coral Dye");
        build.add(DDItems.CANARY_DYE.value(), "Canary Dye");
        build.add(DDItems.WASABI_DYE.value(), "Wasabi Dye");
        build.add(DDItems.SACRAMENTO_DYE.value(), "Sacramento Dye");
        build.add(DDItems.SKY_DYE.value(), "Sky Dye");
        build.add(DDItems.BLURPLE_DYE.value(), "Blurple Dye");
        build.add(DDItems.SANGRIA_DYE.value(), "Sangria Dye");
        build.add(DDItems.ROSE_DYE.value(), "Rose Dye");

        build.add(DDItems.CORAL_BED.value(), "Coral Bed");
        build.add(DDItems.CANARY_BED.value(), "Canary Bed");
        build.add(DDItems.WASABI_BED.value(), "Wasabi Bed");
        build.add(DDItems.SACRAMENTO_BED.value(), "Sacramento Bed");
        build.add(DDItems.SKY_BED.value(), "Sky Bed");
        build.add(DDItems.BLURPLE_BED.value(), "Blurple Bed");
        build.add(DDItems.SANGRIA_BED.value(), "Sangria Bed");
        build.add(DDItems.ROSE_BED.value(), "Rose Bed");

        build.add(DDItems.CORAL_BANNER.value(), "Coral Banner");
        build.add(DDItems.CANARY_BANNER.value(), "Canary Banner");
        build.add(DDItems.WASABI_BANNER.value(), "Wasabi Banner");
        build.add(DDItems.SACRAMENTO_BANNER.value(), "Sacramento Banner");
        build.add(DDItems.SKY_BANNER.value(), "Sky Banner");
        build.add(DDItems.BLURPLE_BANNER.value(), "Blurple Banner");
        build.add(DDItems.SANGRIA_BANNER.value(), "Sangria Banner");
        build.add(DDItems.ROSE_BANNER.value(), "Rose Banner");

        build.add(DDItems.BLUEBERRIES.value(), "Blueberries");
        build.add(DDItems.BLUEBERRY_PIE.value(), "Blueberry Pie");

        //MISC
        build.add("itemgroup.delicate_dyes", "Delicate Dyes");

        //BLOCK TAGS
        build.add(DDTags.Blocks.DELICATE_BEDS, "Delicate Dyes Beds");

        //ITEM TAGS
        build.add(DDTags.Items.BLUEBERRIES, "Blueberries");
