...
public class DDCreativeTabs {
    public static final Supplier<CreativeModeTab> DELICATE_DYES = Services.REGISTRY.registerCreativeModeTab("delicate_dyes", () -> CreativeModeTab.builder(CreativeModeTab.Row.TOP, 0)
