...
public class DDBlocks {
    ...
    public static final Supplier<Block> CORAL_SHULKER_BOX = register("coral_shulker_box", () -> new ShulkerBoxBlock(DDDyeValues.CORAL, DDProperties.BlockP.SHULKER_BOX.mapColor(DDDyeValues.CORAL.getMapColor())), true);
    ...
    public static final Supplier<Block> CANARY_SHULKER_BOX = register("canary_shulker_box", () -> new ShulkerBoxBlock(DDDyeValues.CANARY, DDProperties.BlockP.SHULKER_BOX.mapColor(DDDyeValues.CANARY.getMapColor())), true);
    ...
    public static final Supplier<Block> WASABI_SHULKER_BOX = register("wasabi_shulker_box", () -> new ShulkerBoxBlock(DDDyeValues.WASABI, DDProperties.BlockP.SHULKER_BOX.mapColor(DDDyeValues.WASABI.getMapColor())), true);
    ...
    public static final Supplier<Block> SACRAMENTO_SHULKER_BOX = register("sacramento_shulker_box", () -> new ShulkerBoxBlock(DDDyeValues.SACRAMENTO, DDProperties.BlockP.SHULKER_BOX.mapColor(DDDyeValues.SACRAMENTO.getMapColor())), true);
    ...
    public static final Supplier<Block> SKY_SHULKER_BOX = register("sky_shulker_box", () -> new ShulkerBoxBlock(DDDyeValues.SKY, DDProperties.BlockP.SHULKER_BOX.mapColor(DDDyeValues.SKY.getMapColor())), true);
    ...
    public static final Supplier<Block> BLURPLE_SHULKER_BOX = register("blurple_shulker_box", () -> new ShulkerBoxBlock(DDDyeValues.BLURPLE, DDProperties.BlockP.SHULKER_BOX.mapColor(DDDyeValues.BLURPLE.getMapColor())), true);
    ...
    public static final Supplier<Block> SANGRIA_SHULKER_BOX = register("sangria_shulker_box", () -> new ShulkerBoxBlock(DDDyeValues.SANGRIA, DDProperties.BlockP.SHULKER_BOX.mapColor(DDDyeValues.SANGRIA.getMapColor())), true);
    ...
    public static final Supplier<Block> ROSE_SHULKER_BOX = register("rose_shulker_box", () -> new ShulkerBoxBlock(DDDyeValues.ROSE, DDProperties.BlockP.SHULKER_BOX.mapColor(DDDyeValues.ROSE.getMapColor())), true);
